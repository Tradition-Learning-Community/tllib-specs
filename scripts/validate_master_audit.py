...
if source.get("source_file") != 'maths/00-master.md': errors.append("source file mismatch")
if not (ROOT / 'maths/00-master.md').is_file(): errors.append("authoritative source missing")
