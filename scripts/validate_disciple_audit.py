...
if source.get("source_file") != 'maths/01-disciple.md': errors.append("source file mismatch")
if not (ROOT / 'maths/01-disciple.md').is_file(): errors.append("authoritative source missing")
