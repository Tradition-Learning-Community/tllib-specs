...
- Objects: **100** ({'Concept': 62, 'Definition': 5, 'Equation': 6, 'Example': 1, 'Function': 3, 'Invariant': 1, 'Proof': 10, 'Relation': 7, 'Set': 1, 'State': 4})
- Extraction relations: **99** (`refers_to`: 93; `depends_on`: 6)
- Unresolved: **61**, all preserved
- Duplicate candidates: **12**, none merged
- Revised candidate features: **5**
