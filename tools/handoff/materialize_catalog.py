...
payload = {
    "message": "Install exact generated Identity global handoff catalog",
...
print(f"IDENTITY_CATALOG_COMMIT_SHA={result['commit']['sha']}")
print(f"IDENTITY_CATALOG_CONTENT_SHA={result['content']['sha']}")
