...
dump(REG/'pilot-ir-audit.yaml',{'pilot_count_expected':5,'pilot_contracts_present':5,'pilot_irs_present':5,'recommended_common_schema':['feature_id','source_contract_commit','status','variants','coverage','unresolved','decisions','validation'],'pilots':audit})
...
dump(REP/'decision_required.yaml',{'status':'decision_required','decisions':[{'id':'TLC-PIPELINE-DEC-001','question':'Accept integration with five of five pilot IRs while preserving all documented reservations?','recommended':'yes_with_reservation'},{'id':'TLC-PIPELINE-DEC-002','question':'Authorize publication of local candidate branches and integration PR?','recommended':'yes_after_validation'}]})
